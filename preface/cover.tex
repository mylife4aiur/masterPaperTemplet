...
\cdegree{硕~~士~~学~~位~~论~~文}
\ctitle{企业销售数据挖掘与预测模型研究}
\etitle{Research on Data Mining and Forecasting Model of Pharmaceutical Enterprise Sales}

% 根据需要添加字符间距
\csubject{{\quad\;}计~算~机~科~学~与~技~术}
\cauthor{{\quad\;}许~~　~~铭}
\cauthorno{{\quad\;}21624016}
\csupervisor{{\quad\;}金~~ ~~博　 教授}
